                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="writer" class="form-control" value='<c:out value="${dto.title}"></c:out>' readonly>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input type="checkbox" class="form-check-input" name="completed" ${dto.completed ? "checked" : ""} disabled>
                        </div>
